...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='DAVIS', help='evaluation dataset (default: VOC2012)')
    ...
    if Path('dataset/{}'.format(args.dataset)).exists():
        model = init_model('fcanet', args.backbone, './pretrained_model/fcanet-{}.pth'.format(args.backbone))
        eval_dataset(model, args.dataset,if_sis=args.sis, miou_target=(None if args.miou<0 else args.miou))
